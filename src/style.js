...
export const cardBoundaryColor = (imp) => {
  let value = {
    border: ("1px solid " + `${"button" + imp + "Color"}`)
      .replace("button1Color", button1Color)
      .replace("button2Color", button2Color)
      .replace("button3Color", button3Color)
      .replace("button4Color", button4Color)
      .replace("button5Color", button5Color),
    borderLeft: ("15px solid " + `${"button" + imp + "Color"}`)
      .replace("button1Color", button1Color)
      .replace("button2Color", button2Color)
      .replace("button3Color", button3Color)
      .replace("button4Color", button4Color)
