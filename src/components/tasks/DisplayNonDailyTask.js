...
export default function DisplayNonDailyTask({tasks, header,  deleteTask, markAsDone, markForToBeCompletedToday, todaysTask, editTask}) {
                ...
                return(
                    <Card key={_id} sx={{ maxWidth: '30%'}} style={button5}>
                        ...
                        <CardActions disableSpacing>
                            ...
                            >
                                <PushPinIcon color = {"" + (todaysTask.includes(_id) && 'primary')} />
                            </ExpandMore>
                            <ExpandMore
                            expand={true}
